...
public class RecordListActivity extends AppCompatActivity {
    ...
    private void showDialogDelete(final int idRecord) {
        ...
        dialogDelete.setMessage("Are you sure to delete product?");
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                try {
                    MainActivity.mSQLiteHelper.deleteData(idRecord);
                    Toast.makeText(RecordListActivity.this, "Product Deleted successfully", Toast.LENGTH_SHORT).show();
                }
                catch (Exception e){
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        final EditText edtQty = dialog.findViewById(R.id.edtQty);
